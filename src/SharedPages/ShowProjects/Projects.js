...
const Projects = () => {
    ...
    return (
        <div className='p-11'>
            <h2 className='text-2xl text-center font-serif'>My Projects</h2>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 sm:grid-cols-1 gap-5 p-5'>
                    ...
                    <div className=" -z-0 section-hover card bg-base-100 shadow-xl image-full">
                        ...
                        <div className="card-body ">
                            ...
                            <div className="card-actions justify-end">
                                <a href='https://used-productes.web.app/' className="text-sky-400">Live Demo <hr/></a>
                            </div>
                        </div>
                    </div>
